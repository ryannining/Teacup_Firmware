...
class PinoutsPage(wx.Panel, Page):
  def __init__(self, parent, nb, idPg, font):
    ...
    pinXkeys = [('X_STEP_PIN', 2), ('X_DIR_PIN', 2), ('X_MIN_PIN', 2),
                ('X_MAX_PIN', 2), ('X_ENABLE_PIN', 2),('X_UL4_PIN', 2), ('X_INVERT_DIR', 1),
                ('X_INVERT_MIN', 1), ('X_INVERT_MAX', 1),
                ('X_INVERT_ENABLE', 1)]
    pinYkeys = [('Y_STEP_PIN', 2), ('Y_DIR_PIN', 2), ('Y_MIN_PIN', 2),
                ('Y_MAX_PIN', 2), ('Y_ENABLE_PIN', 2),('Y_UL4_PIN', 2), ('Y_INVERT_DIR', 1),
                ('Y_INVERT_MIN', 1), ('Y_INVERT_MAX', 1),
                ('Y_INVERT_ENABLE', 1)]
    pinZkeys = [('Z_STEP_PIN', 2), ('Z_DIR_PIN', 2), ('Z_MIN_PIN', 2),
                ('Z_MAX_PIN', 2), ('Z_ENABLE_PIN', 2),('Z_UL4_PIN', 2), ('Z_INVERT_DIR', 1),
                ('Z_INVERT_MIN', 1), ('Z_INVERT_MAX', 1),
                ('Z_INVERT_ENABLE', 1)]
    pinEkeys = [('E_STEP_PIN', 2), ('E_DIR_PIN', 2), ('E_ENABLE_PIN', 2),('E_UL4_PIN', 2),
                ('E_INVERT_DIR', 1), ('E_INVERT_ENABLE', 1)]

    self.labels = {'X_STEP_PIN': "Step/UL1 Pin:", 'X_DIR_PIN': "Direction/UL2 Pin:",
                   'X_MIN_PIN': "Minimum Pin:", 'X_MAX_PIN': "Maximum Pin:",
                   'X_ENABLE_PIN': "Enable/UL3 Pin:",
                   'X_UL4_PIN': "UL4 Pin:",
                   ...
                   'Z_STEP_PIN': "Step/UL1 Pin:", 'Z_DIR_PIN': "Direction/UL2 Pin:",
                   'Z_MIN_PIN': "Minimum Pin:", 'Z_MAX_PIN': "Maximum Pin:",
                   'Z_ENABLE_PIN': "Enable/UL3 Pin:",
                   'Z_UL4_PIN': "UL4 Pin:",
                   ...
                   'E_STEP_PIN': "Step/UL1 Pin:", 'E_DIR_PIN': "Direction/UL2 Pin:",
                   'E_ENABLE_PIN': "Enable/UL3 Pin:",
                   'E_UL4_PIN': "UL4 Pin:",
